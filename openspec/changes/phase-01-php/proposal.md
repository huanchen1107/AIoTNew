...
- Create a modern, responsive, and aesthetically rich `index.html` frontend dashboard featuring Highcharts.js line charts and data simulation controls.
...
- Adds the single-page dashboard `index.html` and `.gitattributes` to the project root.
